...
public class MongoDBConnection implements DBConnection { 
	...
	@Override public void unsetFavoriteItems(String userId, List<String> itemIds) { 
		// TODO Auto­generated method stub
		db.getCollection("users").updateOne(new Document("user_id", userId), 
	...
	public Set<String> getFavoriteItemIds(String userId) {
		...
		if (iterable.first() != null && iterable.first().containsKey("favorite")) {
			@SuppressWarnings("unchecked") List<String> list = (List<String>) iterable.first().get("favorite");
	...
	public Set<Item> getFavoriteItems(String userId) {
		...
		for (String itemId : itemIds) { FindIterable<Document> iterable = db.getCollection("items").find(eq("item_id",itemId));
	...
	// TODO Auto­generated method stub
		...
		if (iterable.first() != null && iterable.first().containsKey("categories")) {
			@SuppressWarnings("unchecked") List<String> list = (List<String>) iterable.first().get("categories");
			categories.addAll(list);
		}
		return categories;
	}

	@Override public List<Item> searchItems(double lat, double lon, String term) {
	...
	@Override public String getFullname(String userId) {
	...
	@Override public boolean verifyLogin(String userId, String password) {
