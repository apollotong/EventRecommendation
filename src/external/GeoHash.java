...
// A copy from http://developer-should-know.com/post/87283491372/geohash-encoding-and-decodingalgorithm 
...
public static String encodeGeohash(double latitude, double longitude, int precision) { 
	...
	while (geohash.length() < precision) {
		if (isEven) { base32CharIndex = (base32CharIndex << 1) | divideRangeByValue(longitude, lonRange); } 
			else {
	...
	public static void main(String[] args) { 
		...
		System.out.println(encodeGeohash(58.64911, 10.40744, 8)); 
	}
}